...
class GPT3(Base):
    ...
    def translate(self, text):
        ...
        self.data["prompt"] = f"Please help me to translate，`{text}` to Traditional Chinese"
                ...
                messages=[
                    {
                        ...
                        "content": f"Please help me to translate,`{text}` to Traditional Chinese, please return only translated content not include the origin text",
                    }
                ],
            )
            t_text = (
